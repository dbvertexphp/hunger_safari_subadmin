...
export default function ComplexTable() {
  ...
  const [restaurantId, setRestaurantId] = React.useState(''); // State for restaurant ID
  ...
  const handleEditClick = (subCategory) => {
    setEditSubCategory({
      ...
      restaurant_id: restaurantId, // Use fetched restaurant ID
    });
    onEditOpen();
  };
